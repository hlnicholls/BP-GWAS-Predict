...
pval01 = dt2[dt2$minP.min > 0.1] #2013
...
pval015 = dt2[dt2$minP.min > 0.7] #57
pval0155 = dt2[dt2$minP.min > 0.75] #37
...
fwrite(pval015, 'pval015_forPPI.txt', row.names = FALSE)
fwrite(pval0155, 'pval0155_forPPI.txt', row.names = FALSE)
...
fwrite(interactors, "PPI150_gene_interactions_evangelou.txt", sep="\t", row.names = F, quote = F)
...
interactors <- fread("PPI150_gene_interactions_evangelou.txt")
...
write.table(no_ld_genes,"pval015_filtered_unassociated_genes.txt",sep="\t", row.names = F, quote = F)
...
ppifiltered1 <- fread('pval015_filtered_unassociated_genes.txt')
